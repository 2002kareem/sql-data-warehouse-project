...
============================================================================================
Script Purpose :
	This stored procedure porforms the ETL (Extract , Transform , Load) process to 
	populate the 'silver' schema thable from 'bronze' schema.
